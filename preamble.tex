...
% Bibliography setup
\usepackage[backend=biber,citestyle=numeric, sortcites=true, style=ieee, sorting=nyt, backref=true]{biblatex}

\bibliography{Bibliography} % add here other bibliography files that you may want
...
% SVG Support was disable to allow compilation with XeLatex, if enable please use LuaLatex
...
% this adds some fancy ligatures in math fonts (e.g. used in us)
%\defaultfontfeatures{ Scale=MatchLowercase, Ligatures=TeX }
% alternative: set arial
%\setmainfont{Arial}[Scale=1.0]
% fix math fonts (e.g. us) in helvet
\usepackage{unicode-math}
% based on https://tex.stackexchange.com/a/572292 :
\usepackage{newtxsf}
% improvement on typography
...
\usepackage{diagbox} % Tabular column heads and multilined cells

% add marks
\usepackage{pifont}
\newcommand{\cmark}{\ding{51}}%
\newcommand{\xmark}{\ding{53}}%
\newcommand{\pmark}{\ding{117}}%
% added for new hl color
\usepackage{soul}
\usepackage{color}
...
% maybe add \setcounter{tocdepth}{4} and \setcounter{secnumdepth}{4}?
