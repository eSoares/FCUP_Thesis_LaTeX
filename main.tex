...
\documentclass[11pt, twoside, table,xcdraw
                %,final % when releasing the "final" version for review, uncomment this line, this will "fix" the acronyms
                ]{Thesis}
...
\pagestyle{empty}
\includepdf[pages={1},pagecommand={},scale=1]{build/front}
\cleardoublepage
\includepdf[pages={2},pagecommand={},scale=1]{build/front}
\cleardoublepage
\pagestyle{fancy}
